...
rewardCustomerSchema.index({ shop: 1, shopifyCustomerId: 1 }, { unique: true });
rewardCustomerSchema.index({ shop: 1, email: 1 });

export const RewardCustomer =
  mongoose.models.RewardCustomer || mongoose.model("RewardCustomer", rewardCustomerSchema);
